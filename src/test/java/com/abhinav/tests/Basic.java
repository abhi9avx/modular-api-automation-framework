  ...
  public static void main(String[] args) {
    ...
    String addPlaceResponse =
        given()
            ...
            .then()
            .assertThat()
            .statusCode(200) // verify API executed successfully
            ...
            .extract()
            .response()
            .asString(); // store response for reuse
    ...
    given()
        .log()
        .all() // log full request for debugging visibility
        ...
        .then()
        .assertThat()
        .statusCode(200) // validate update call success
    ...
    String getPlaceResponse =
        given()
            .log()
            .all() // log request for traceability
            ...
            .then()
            .assertThat()
            .statusCode(200) // verify API success
            .body("address", equalTo(updatedAddress)) // validate updated value returned
            .extract()
            .response()
            .asString(); // extract response for assertion
